...
class Recipe(models.Model):
    ...
    thumbnail = ProcessedImageField(upload_to='recipe_thumbnail', processors=[ResizeToFill(960,540)], format="JPEG", options={'quality':90})
    thumbnail2 = ProcessedImageField(upload_to='recipe_thumbnail', processors=[ResizeToFill(960,540)], format="JPEG", options={'quality':90})
    thumbnail3 = ProcessedImageField(upload_to='recipe_thumbnail', processors=[ResizeToFill(960,540)], format="JPEG", options={'quality':90})
...
class Restaurant(models.Model):
    ...
    description = models.TextField()
    building_thumbnail = ProcessedImageField(upload_to='restaurant_thumbnail/building', processors=[ResizeToFill(640,480)], format="JPEG", options={'quality':80})
    menu_thumbnail = ProcessedImageField(upload_to='restaurant_thumbnail/menu', processors=[ResizeToFill(640,480)], format="JPEG", options={'quality':80})
    food_thumbnail_1 = ProcessedImageField(upload_to='restaurant_thumbnail/food', processors=[ResizeToFill(640,480)], format="JPEG", options={'quality':80})
    food_thumbnail_2 = ProcessedImageField(upload_to='restaurant_thumbnail/food', processors=[ResizeToFill(640,480)], format="JPEG", options={'quality':80})
    created_date = models.DateTimeField(default=timezone.now)
